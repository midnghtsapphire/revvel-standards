...
const THEMES = [
  ...
  },
  {
    ...
    prompt:
      'A heavy graphite pencil drawing a dense, thick black line across coarse paper—until the tip deliberately snaps with a sharp, resonant crack. Text Overlay: "Draw the boundary line." Extreme macro shot focused entirely on the pencil tip meeting the rough fibers of the paper grain.',
  },
  {
    id: "un-linked",
...
export default function Home() {
  ...
  const pollStatus = useCallback(
    async (provider: string, providerJobId: string): Promise<string | null> => {
      try {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        try {
          ...
          failureReason =
            errBody.failure_reason ?? errBody.error ?? failureReason;
      ...
      const shouldPoll =
        ...
        Boolean(data.provider_job_id) &&
        !TERMINAL_STATUSES.has(data.render_status);
      ...
      <div className="max-w-5xl mx-auto px-4 py-12">
        <header className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Transform your .wav files and avatar images into AI-generated music
            videos. Powered by OpenRouter orchestration and real video
            generation APIs.
          </p>
        </header>
            ...
            <form onSubmit={handleGenerate} className="space-y-6">
              ...
              <div>
                ...
                >
                  ...
                  <option value="pxle">
                    &quot;it&apos;s all my fault&quot; by pxle (Stripped-back
                    ambient)
                  </option>
                  <option value="rta">
                    &quot;RTA — Stillness at 3AM&quot; (ElevenLabs Trend - 139
                    BPM ambient-electronic)
                  </option>
                  <option value="vinyl">
                    &quot;Vinyl Crackle &amp; Low Hum&quot; (Pure Foley)
                  </option>
                </select>
              </div>
            ...
            {job && (
              ...
              >
                ...
                <div className="space-y-1.5 text-sm text-gray-700 dark:text-gray-300">
                  ...
                  {job.provider_job_id && (
                    <div>
                      <span className="font-medium">Provider Job:</span>{" "}
                      {job.provider_job_id}
                    </div>
                  )}
                  ...
                  {job.message && (
                    <div className="mt-2 text-gray-600 dark:text-gray-400 italic text-xs">
                      {job.message}
                    </div>
                  )}
                </div>
          ...
          <aside className="space-y-8">
            <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                Join the high-status community of Architects building the
                &quot;Sub-Zero Cognitive Freeze.&quot;
              </p>
