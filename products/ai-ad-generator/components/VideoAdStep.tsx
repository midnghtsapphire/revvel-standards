...
import type { StaticCreative } from "../types";
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 text-sm">
            Your video script is ready — connect an avatar API to render the
            video
          </p>
        </div>
        <button
      ...
      <div>
        ...
        <div className="mt-4 p-4 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-xl text-sm text-amber-800 dark:text-amber-300">
          <strong>Developer note:</strong> To enable live video rendering, add
          your chosen API key to{" "}
          ...
          route using the script above. The script format is already structured
