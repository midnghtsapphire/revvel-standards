...
import type { AnalyticsData, Campaign } from "../../types";
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-4 py-3 text-gray-700 dark:text-gray-300">
                        {c.spend != null ? `$${c.spend}` : "—"}
                      </td>
                      <td className="px-4 py-3 text-gray-700 dark:text-gray-300">
                        {c.revenue != null ? `$${c.revenue}` : "—"}
                      </td>
                      <td
                        className={`px-4 py-3 font-semibold ${Number(roas) >= 2 ? "text-green-600" : "text-gray-700 dark:text-gray-300"}`}
                      >
                        {roas !== "—" ? `${roas}x` : "—"}
                      </td>
                      ...
                      <td className="px-4 py-3 text-gray-500">
                        {c.clicks != null ? c.clicks.toLocaleString() : "—"}
                      </td>
                      <td className="px-4 py-3 text-gray-500">
                        {ctr !== "—" ? `${ctr}%` : "—"}
                      </td>
...
function KPI({
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-4 text-center">
      <p
        className={`text-2xl font-extrabold ${highlight ? "text-green-600 dark:text-green-400" : "text-gray-900 dark:text-white"}`}
      >
        {value}
      </p>
