    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <section className="text-center py-20 sm:py-28">
        ...
        <p className="text-xl text-gray-500 dark:text-gray-400 max-w-2xl mx-auto mb-10">
          Scrape product data → AI generates copy → render static creatives →
          export video scripts. The complete ad automation pipeline in one tool.
        </p>
          ...
          {[
            {
              ...
              icon: "🔗",
              title: "Paste URL",
              desc: "Enter any product page link",
            },
            {
              step: "2",
              icon: "🤖",
              title: "AI Generates",
              desc: "Copy, script & 3 variants",
            },
            {
              step: "3",
              icon: "🖼",
              title: "Render Creative",
              desc: "Pick template, preview PNG",
            },
            {
              step: "4",
              icon: "🚀",
              title: "Launch Campaign",
              desc: "Save, track, optimize",
            },
          ].map((item) => (
            <div
              key={item.step}
      ...
      <section className="mb-20 bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-10 text-center text-white">
        ...
        <p className="text-blue-100 mb-8 max-w-xl mx-auto">
          No design skills, no copywriting skills needed. Add your product URL
          and let AI do the heavy lifting — just like Zeely AI, but open-source
          and self-hosted.
        </p>
        <Link
          href="/create"
