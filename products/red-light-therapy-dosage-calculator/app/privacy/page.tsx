...
const sections: { id: string; title: string; paragraphs: string[] }[] = [
  {
    ...
    paragraphs: [
      ...
      "This is a direct-to-consumer wellness tool that runs entirely in your browser. We are not a HIPAA covered entity or business associate at launch and we do not claim HIPAA compliance. We do not claim that this Service is HIPAA-compliant, HIPAA-certified, or cleared by any regulatory body. Consumer health privacy rules, including the FTC Health Breach Notification Rule, may still apply.",
    ],
  },
  {
    id: "collect",
