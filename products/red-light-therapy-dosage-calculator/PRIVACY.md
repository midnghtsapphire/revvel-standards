...
> This document is not legal advice. Counsel must review before production launch and as part of PIA [#16110](https://github.com/midnghtsapphire/revvel-standards/issues/16110).
...
| --- | --- | --- |
| Calculator inputs | Irradiance, target dose, duty cycle, treatment area | Needed to compute session timing |
| Account data (if enabled) | Email, authentication identifiers | Only if accounts ship |
| Health-related logs (if enabled) | Session history, symptom notes, progress photos | Treated as sensitive consumer health data |
| Technical data | Device type, approximate region, diagnostics | Minimized; no sale of health data |

We practice **data minimization**: we collect only what a feature needs. Features that are not enabled do not collect their listed data.
...
## 7. Health information breach notification (FTC HBNR)
...
Depending on where you live, you may have rights to access, correct, delete, or export personal data, and to appeal a denial. Email <privacy@revvel.io>. California residents may have additional rights under CCPA/CPRA for sensitive personal information. Washington residents may have rights under the My Health My Data Act for consumer health data. EU/UK users: health data is special-category data under GDPR Article 9 and requires an appropriate lawful basis (typically explicit consent) before collection.

---

## 9. Children

The app is not directed to children under 13 (or under 16 where that higher age applies). We do not knowingly collect personal information from children.

---

## 10. International users

If you use the app from outside the United States, you understand information may be processed in the United States or other countries where we or our processors operate, with appropriate transfer safeguards where required.

---

## 11. Changes

We will update this policy when our practices change. The effective date at the top will change, and material changes affecting health data will be highlighted in the product or by email when accounts exist.
