...
export const metadata: Metadata = {
  ...
  description:
    "Get premium, pre-qualified insurance leads for ACA, Life, Health, and Medicare agents. Boost your sales with our exclusive live transfers and outbound leads.",
};
      ...
      >
          ...
          <div className="max-w-5xl mx-auto flex justify-between items-center">
            ...
            <nav>
              <ul className="flex space-x-4">
                ...
                <li>
                  <a href="#what-we-offer" className="hover:text-gray-300">
                    What We Offer
                  </a>
                </li>
                <li>
        ...
        <footer className="bg-gray-900 text-gray-400 py-8 text-center text-sm border-t border-gray-800 mt-auto">
          <div className="container mx-auto px-4">
            <p>
              &copy; {new Date().getFullYear()} Life Wizard. All rights
              reserved.
            </p>
            <p className="mt-2">
              High-Quality Insurance Leads - Live Transfers & Exclusive Outbound
            </p>
          </div>
        </footer>
