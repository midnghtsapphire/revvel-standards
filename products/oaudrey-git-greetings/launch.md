...
When a developer takes the time to open an issue or submit a pull request, the standard response is often just a cold, automated CI build status. We wanted to change that.
