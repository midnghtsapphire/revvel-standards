...
export function countChecked(statuses: Map<string, Set<string>>): {
  checked: number;
...
export function buildDhfMarkdown(
  ...
  lines.push("");
  lines.push(
    "> Generated by [FDA Design Controls Tool](https://github.com/midnghtsapphire/revvel-standards)  ",
  );
  lines.push(
    "> Reference: 21 CFR 820.30 | FDA Design Controls Guidance (https://www.fda.gov/media/116762/download)",
  );
  lines.push("");
...
export function buildDhfCsv(
  ...
  rows.push("");
  rows.push(
    '"Device Name","Version","Project Lead","Device Class","Start Date","Target Date"',
  );
  rows.push(
    [
