  ...
  return (
    <div className="bg-white rounded-lg shadow p-6">
      <h2 className="text-2xl font-semibold mb-4">
        🧹 CSV / Excel Dedupe Tool
      </h2>
      <p className="text-sm text-slate-600 mb-4">
        Upload your existing leads. We remove duplicates via exact email/phone
        matching and fuzzy name matching (Fuse.js). 100% client-side — your data
      ...
      {stats && (
        <div className="bg-slate-50 p-4 rounded mb-4">
          ...
          <ul className="text-sm space-y-1">
            <li>
              Original rows: <strong>{stats.original}</strong>
            </li>
            <li>
              Duplicates removed:{" "}
            ...
            <li>
              Remaining clean leads:{" "}
              <strong className="text-emerald-600">{stats.remaining}</strong>
            </li>
          </ul>
          <button
            onClick={download}
