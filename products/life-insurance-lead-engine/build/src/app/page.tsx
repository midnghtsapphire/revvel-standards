    ...
    <main className="min-h-screen p-6 max-w-6xl mx-auto">
      <header className="mb-8">
        ...
        <p className="text-slate-600 mt-2">
          Generate high-value medical professional leads from the NPPES NPI
          Registry, score them by income tier, and produce tailored pitch
          scripts.
        </p>
      </header>
      ...
      <footer className="text-center text-sm text-slate-500 mt-12 pb-6">
        © {new Date().getFullYear()} Life Insurance Lead Engine. NPPES data is
        public domain. Use responsibly. TCPA/GDPR/CCPA compliant operation
        required.
      </footer>
    </main>
  );
