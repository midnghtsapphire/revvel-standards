...
| Founder Ops Pack | $29 | *(create tomorrow — daily limit)* | covers/cover-founder.jpg |
...
4. Format: `playbook` or `digital download`
5. Audience: `solo founders` or `ai coding`
...
*See also: `products/GUMROAD-LISTING.md`, `products/GUMROAD-PACKS.md`, `docs/MARKETPLACE_GUIDE.md`, `REVENUE_GATE.md`.*
