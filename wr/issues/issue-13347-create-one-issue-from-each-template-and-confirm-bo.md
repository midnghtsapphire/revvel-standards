# WR: [WR]   create one issue from each template and confirm both land on the board and trigger the same WR path, with the lightweight one carrying the distinguishing label.
