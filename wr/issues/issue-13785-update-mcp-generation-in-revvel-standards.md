# WR: [WR] update mcp generation in revvel-standards
...
Here are two master prompts designed for a landing page featuring an MCP (Model Context Protocol) host or client architecture.
​Because MCP is all about connecting AI models to data sources and local tools seamlessly, these prompts focus on showing connected pipelines, server nodes, and context streams melting into a premium, 3D glossy UI.
