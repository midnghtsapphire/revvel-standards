# WR: [WR] update revvel-standards for templates for each of these brand types find template on the web and for mobile
...
> **Prompt:** A vertical 9:16 cinematic hero shot of a premium, modern e-commerce landing page for a natural beauty product line. The interface uses layered, thick-cut glassmorphic panels floating gracefully over a dark, charcoal gradient background with swirling atmospheric haze. Floating beside the central module are a product icon and a rating badge, which uses a distinct color palette optimized for a premium beauty brand.
> 
### E-commerce Hub (Multiple Categories)
> **Prompt:** A close-up cinematic shot of an e-commerce hub designed for a music launch. A prominent, highly translucent glassmorphic navigation pill floats elegantly, designed for a vertical mobile screen. The layout utilizes thick-cut, translucent glass cards hovering over a minimalist gradient background, which uses a cohesive color palette optimized for a premium digital brand.
> 
### Security Software Landing Page
> **Prompt:** A cinematic hero shot of an ultra-modern landing page featuring a premium glassmorphic interface for security software. Translucent data pipelines and circuits, rendered as glowing cyan and gold light paths, weave and connect multiple frosted glass nodes. Thick, atmospheric low fog rolls wrap around the UI layers, catching sharp cool-blue rim lighting on the refractive, glossy glass edges. Photorealistic, 8k resolution, elegant 3D realism, studio lighting.
> 
### Eco-Friendly Product Showcase
> **Prompt:** A close-up cinematic shot focusing on a pair of vintage-style retro fashion sneakers sitting on a minimalist, textured stone surface, representing eco-friendly products. Swirling, thick atmospheric fog drifts slowly behind the floating UI, catching faint light leaks and casting soft physical shadows. Natural window light sweeps across the frame, highlighting the fine stitching and material textures.
> 
### YouTube Blogger Website Hero
> **Prompt:** A vertical 9:16 cinematic shot of a blog or YouTube blogger landing page optimized for a premium tech ad campaign. A massive, beautiful vinyl record or album cover art is displayed on a floating 3D frosted glass card. Layers of semi-transparent, thick-cut frosted glass panels hover over a dark, minimalist background, creating an atmospheric haze perfect for a viral music video style.
> 
### Business News / News Person Site
> **Prompt:** A professional 1:1 square grid composition presenting multiple distinct logo designs, each for a different brand. A central, layered frosted glass canvas floats over a dark, minimalist technical grid background, utilizing a color palette optimized for a premium digital brand. The view includes scrolling text column showing real-time presidential briefing summaries.
> 
