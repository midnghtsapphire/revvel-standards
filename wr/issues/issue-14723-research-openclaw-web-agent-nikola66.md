...
- [x] **BOM (Bill of Materials)** — ranked tool/runtime list per category: which is best, what it costs, why one beats another
- [x] **Community chatter** — Reddit, forums, social: what buyers/users want from browser-native agents
