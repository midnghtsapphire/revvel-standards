# WR: [WR] create process that flags off duplicate WR and PR?
...
create a process that flags duplicate WR and/or PR

### Objective

I need to flag off any WR or PR that are duplicates for example the logo , glassmorphic ui we do not want to overwirte what is there
