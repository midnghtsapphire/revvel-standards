# WR: [WR] engine for SAS creation and campaigns social media
...
There is way more to setup prompts and testes for sas research and build and implement it s2m Promoting a SaaS platform or an affiliate link like GoHighLevel on TikTok requires a visual layout that instantly signals wealth, business automation, and high-tech freedom. The goal is to make the viewer want to click the link in your bio to copy your exact setup.
​Here are two master prompts tailored for a 9:16 vertical video layout to showcase a premium affiliate landing page.
​Prompt 1: The "SaaS Business in a Box" Funnel (High-Converting Affiliate Hook)
​Prompt: A vertical 9:16 cinematic hero shot of a premium, ultra-modern link-in-bio landing page promoting a high-level marketing automation software platform. The interface features a series of stacked, floating glassmorphic buttons and widgets hovering over a dark, luxury office background. The primary glass widget displays a glossy, translucent smartphone mockup showing an active, automated sales pipeline moving leads in real-time. Below it, a high-contrast, glowing button text reads "Get My Free 14-Day Trial & Blueprints". Thick, dramatic atmospheric fog rolls across the lower half of the frame, catching sharp streams of neon teal and warm gold ambient light on the crisp, refractive glass edges. Photorealistic, 8k resolution, elegant 3D realism, studio lighting, hyper-detailed marketing funnel layout, scroll-stopping aesthetic.
​Prompt 2: The Automated Freedom Dashboard (The Affiliate Lifestyle Angle)
​Prompt: A medium close-up cinematic shot optimized for a vertical mobile layout, showcasing a sleek automated business dashboard on a floating glass canvas. The interface utilizes thick-cut frosted glass panels hovering over a minimalist gradient background of deep sapphire and charcoal. The top glass panel highlights a sharp, glowing revenue graph tracking upward, paired with a clean monospaced text block displaying "System Status: Fully Automated 24/7". Overlapping the data layers is a prominent, glossy glassmorphic card showcasing a downloadable "Done-For-You Snapshot Pack". Sharp caustics and delicate light leaks ripple across the reflective surfaces, casting realistic physical shadows underneath. Hyper-realistic, 8k, ray-traced reflections, premium UX/UI software visualization, 3D glossy realism.
