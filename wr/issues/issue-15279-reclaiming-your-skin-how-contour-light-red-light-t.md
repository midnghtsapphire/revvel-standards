...
- [x] **Formal Privacy Impact Assessment (PIA)** — See [PIA Package](compliance/wr-15279/privacy-impact-assessment.md) with legal/compliance covering HIPAA, FDA SaMD, CCPA/CPRA, WA MHMDA, GDPR (if EU traffic), and applicable state laws.
