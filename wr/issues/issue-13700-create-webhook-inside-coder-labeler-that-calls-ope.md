# WR: [WR] create webhook inside coder-labeler that calls openrouter and makes it available to do work
...
| Description | ### Output Type (optional)
...
create webhook inside coder-labeler that opens no-api perplexity instantiation for assigneee
