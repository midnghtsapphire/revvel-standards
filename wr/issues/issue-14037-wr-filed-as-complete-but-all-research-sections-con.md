...
4. Add a CI or lint check that fails the pipeline when known placeholder patterns such as '{STARS}', '{OPEN_ISSUES}', or '[Research findings...]' are detected in WR documents targeting the main branch. |
| Private | {IS_PRIVATE} |
