# WR: [WR] HOW DO WE CORRECT THIS ERROR? check-for-scaffolding Node.js 20 actions are deprecated. actions are running on Node.js 20 and may not work as expected: actions/checkout@v4, actions/github-script@v7.
