...
Redundant content: wr/issues/issue-15343-_.md contains two near-identical consecutive HTML comments ("Mark [x] ONLY when…") — template duplication drift.
...
Synthetic data as analytics: buildAnalytics() in app/analytics/page.tsx fabricates deterministic CTR/ROAS curves (clicks = impressions 0.038 (1 + i_ 0.005)) with no visual "demo data" indicator — misleading for a shipped product.
