# WR: [WR] Implement this repository functionality into revvel-standards creating skills from mcp
...
implement this repositorys functionality into revvel-standards

https://github.com/filiksyos/mcptoskill
make sure it can be a sellable app and i get a ui website for it to test it so the app can locate a search on any mcps for the task any mcp-this is just one option. then you should be able to upload an mcp or copy and paste the code. and it should also be able to take a skill and make it an mcp. full do deep web research provide ideas and high performing seo sem options. maybe this should refine our search and/or research engine even more?
