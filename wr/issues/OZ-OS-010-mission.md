# WR: MISSION.md for Oz OS Repository Root
...
Single file: `oz-os/MISSION.md`

## Content Requirements

This is the first file anyone reads when entering the `oz-os` repo. Without it,
every contributor defaults to "make the agent give better answers" and misses
the entire point.
...
- Communicates the optimization target clearly
- A new contributor reading only this file understands what Oz OS is
