# WR: [WR] Research and implement this template https://n8n.io/workflows/11794-qualify-insurance-leads-using-vapi-gpt-4-proposals-and-airtable/
...
[WR] Research and implement cli, mcp, api, github action or github app this template https://n8n.io/workflows/11794-qualify-insurance-leads-using-vapi-gpt-4-proposals-and-airtable/ and more

### Objective

Use revvel-standards do exhaustive research on procuring automation templates and everything available for foss or paid cli, mcp, skills, pdf, api for life insurance, whole and term burial insurance, pet i surface and anything relevant to be in revvel-standards available for any new WR.[WR] Research and implement this template https://n8n.io/workflows/11794-qualify-insurance-leads-using-vapi-gpt-4-proposals-and-airtable/ make sure, revvel standards includes always looking for templates in gum loop. Make n 8 n and zapier for any and all projects.
