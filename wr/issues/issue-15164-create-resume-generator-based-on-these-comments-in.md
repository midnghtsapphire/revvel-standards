...
<img width="720" height="1560" alt="Image" src="https://github.com/user-attachments/assets/043e95a4-7f75-495d-80b6-bfad95bbf2b6" />
<img width="720" height="1560" alt="Image" src="https://github.com/user-attachments/assets/72e08c26-b28f-4074-b9f8-eadc942bdadd" />
<img width="720" height="1560" alt="Image" src="https://github.com/user-attachments/assets/9e7949fa-e1d5-4f34-9000-4807feddb879" />
<img width="720" height="1560" alt="Image" src="https://github.com/user-attachments/assets/6630e5be-5cfe-45a6-882d-979bdf87499b" />
<img width="720" height="1560" alt="Image" src="https://github.com/user-attachments/assets/b8363511-fcdd-47b0-96fc-57a329e469be" />
<img width="720" height="1560" alt="Image" src="https://github.com/user-attachments/assets/78a34262-a149-4001-9e79-293e9fcafc16" />
<img width="720" height="1560" alt="Image" src="https://github.com/user-attachments/assets/f57ebb88-0b25-4574-8266-d69bddeccdb4" />

https://www.reddit.com/r/recruitinghell/s/en2zyR33dj
...
**Build Decision**: **BLOCKED** - Cannot proceed without critical evidence
...
- Clear, urgent need with measurable outcome (interview callbacks)
...
2. **Blog Content**:
   ...
   - "Common Resume Formatting Mistakes That Kill Applications"
...
**Hook**: "I saw this recruiter-approved resume format on Reddit and built a free tool to generate it"
...
**Emotional Triggers**: Frustration, desperation, feeling invisible to employers
...
4. Competitor pricing verification through manual testing
...
3. Real-time preview
4. PDF export (genuinely free, no paywall)
  ...
  validate:
    ...
    steps:
      - name: Check Required Fields
        run: |
          if grep -q "_No response_" <<< "${{ github.event.issue.body }}"; then
            echo "::error::Work Request has incomplete required fields"
            exit 1
          fi
```
...
jobs:
  extract:
    if: contains(github.event.comment.body, '/extract-screenshots')
    steps:
      - name: OCR Screenshots
        uses: actions/ocr-action@v1
        with:
...
**CRITICAL NEXT STEP**: This WR cannot proceed until someone manually accesses the Reddit thread and screenshots to extract actual requirements. Without this evidence, any development would be based on assumptions rather than user needs.
