# Contributing — No-Kill Shelter Business
...
```text
feat: add foster intake checklist
...
- Treat animal PII and adopter contact data as sensitive — never commit real
  contact lists, medical records, or unredacted case notes.
