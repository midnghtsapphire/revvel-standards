...
**Music Projects** is the private hub for music production, songwriting, stem
separation, and distribution tooling under Freedom Angel Corp /
MIDNGHTSAPPHIRE. It is documentation-and-standards first; shippable apps may
link out (for example Music Video Creator in `revvel-standards`).
...
- When adding a tool, prefer FOSS stacks (Demucs/Spleeter-class separation,
  Node or Python CLIs) and record live URLs in README when deployed.
