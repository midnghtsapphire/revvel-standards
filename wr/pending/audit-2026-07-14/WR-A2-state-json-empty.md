...
An empty-but-valid file is worse than a missing file — everything "works" while carrying no data. Guards must assert _content invariants_, not just parseability.
