...
`pull_request_target` is the single most exploited GitHub Actions misconfiguration. Rule of thumb the fleet should memorize: _untrusted code and secrets never share a job._
