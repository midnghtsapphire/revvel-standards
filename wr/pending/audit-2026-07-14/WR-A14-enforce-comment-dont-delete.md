...
(4) Exempt generated/lock/state files via an allowlist (package-lock.json, dashboard-data.json, docs/biome/_, wr/memory/_.jsonl etc.) so the gate stays 100% signal (WR-A9 lesson: never train agents to ignore a noisy checker).
