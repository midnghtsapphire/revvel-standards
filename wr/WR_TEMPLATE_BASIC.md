...
- **Scaffolding & delivery evidence** — for each selected shape, track scaffolded, implemented, build, test, and commit/PR evidence; create focused follow-up PRs on the same WR if any shape is still incomplete
