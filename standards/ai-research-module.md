...
- [ ] The document follows Revvel Standard formatting (see `standards/agent-factory.md` for style)
...
See `standards/agent-factory.md` for the full trigger matrix.
...
- Related Revvel Standards:
  - `standards/agent-factory.md` — agent routing and orchestration
  - `standards/github-app-integration.md` — GitHub App setup for automation
  - `standards/vault-agent.md` — secret management for API keys
