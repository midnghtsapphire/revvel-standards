...
**Parent Standard:** [`standards/api-gatekeeper.md`](standards/api-gatekeeper.md)
**Related Standards:** [`standards/secret-management.md`](standards/secret-management.md), [`KONG_GATEWAY.md`](../../standards/KONG_GATEWAY.md)
...
See [`standards/sso-saml.md`](standards/sso-saml.md) for full SAML configuration.
...
keywords:
  strongdm:
    standard: "standards/strongdm-api-control.md"
    alternatives:
      - "Kong Gateway OSS (API routing/auth)"
      - "Infisical (secret management)"
      - "Doppler (CI/CD secret sync)"
  api-control:
    standard: "standards/api-gatekeeper.md"
  access-management:
    standard: "standards/secret-management.md"
```
...
|----------|-------------|
| [`standards/api-gatekeeper.md`](standards/api-gatekeeper.md) | Parent standard — overall API security architecture |
| [`standards/secret-management.md`](standards/secret-management.md) | Secret management tooling (Infisical, Vault/OpenBao, SOPS) |
| [`KONG_GATEWAY.md`](../../standards/KONG_GATEWAY.md) | Kong Gateway OSS — Layer 2 API proxy implementation |
| [`standards/sso-saml.md`](standards/sso-saml.md) | User provisioning via GitHub SSO/SAML |
| [`SELF_HEALING_SECRET_ROTATION.md`](../SELF_HEALING_SECRET_ROTATION.md) | Automated secret rotation with retry + escalation |
| [`standards/vault-agent.md`](standards/vault-agent.md) | HashiCorp Vault for enterprise secret management |
| [`standards/security.md`](standards/security.md) | Overall security posture and tooling |
