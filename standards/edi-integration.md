...
| **Meta/Facebook** | Ad campaign posting | `standards/marketing-automation.md` | Active |
| **TikTok** | Ad campaign posting | `standards/marketing-automation.md` | Active |
| **X/Twitter** | Ad campaign posting | `standards/marketing-automation.md` | Active |
...
| Rotate API keys every 90 days | Per `standards/security.md` |
