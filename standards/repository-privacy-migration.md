...
- `standards/security.md` — General security policy (secrets, headers, rate limiting)
- `standards/deployment.md` — Deploy agent model and production deployment workflow
- `standards/github-app-integration.md` — GitHub App setup for cross-account automation
- `docs/GITHUB_ENTERPRISE_RESEARCH.md` — Research on GitHub Enterprise vs. personal account options
- `standards/test-environments.md` — Dev → staging → live-test → production pipeline
