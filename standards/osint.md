...
- `standards/automated-audit-agent.md` — continuous auditing that consumes OSINT output
- `standards/api-gatekeeper.md` — gatekeeper that enforces OSINT-derived blocklists
