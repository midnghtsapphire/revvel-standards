...
All GitHub App credentials follow the Vault Agent Standard (`standards/vault-agent.md`).
...
- Related Revvel Standards:
  - `standards/vault-agent.md` — secret management
  - `standards/security.md` — overall security policy
  - `standards/mcp.md` — MCP server integration
  - `docs/GITHUB_ENTERPRISE_RESEARCH.md` — Enterprise vs. personal deep dive
  - `standards/ai-research-module.md` — how to use AI agents for research
