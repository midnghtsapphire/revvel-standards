...
- [SSO & SAML Identity Standard](standards/sso-saml.md) - GitHub organization SSO and SAML identity resolution
- [Public Identity Standard](standards/public-identity.md) - GitHub profile and public identity management
- [Security Standard](standards/security.md) - General security requirements including authentication
- [Secret Management Standard](standards/secret-management.md) - Managing IdP credentials and SCIM tokens
