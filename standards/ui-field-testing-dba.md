...
- `standards/field-mapping.md` — defines how field maps are created and maintained
- `standards/database-architecture.md` — defines the PostgreSQL database standard
- `standards/testing.md` — defines the overall testing framework
...
| Document | Purpose |
|---|---|
| `standards/field-mapping.md` | How to create and maintain field maps |
| `standards/database-architecture.md` | PostgreSQL database architecture and hosting |
| `standards/testing.md` | Full testing framework — unit, integration, E2E |
| `standards/data-model.md` | Data model design rules and naming conventions |
