...
**Parent Standard:** standards/audrey-autonomous-agent.md
...
|---|---|---|
| **AUDREY Autonomous Agent** | Parent agent standard | `standards/audrey-autonomous-agent.md` |
| **Agent Factory** | Multi-agent orchestration | `standards/agent-factory.md` |
...
| **Vault Agent** | Secrets & credential management | `standards/vault-agent.md` |
| **Auto-Documentation** | Documentation standards | `standards/auto-documentation.md` |
...
- Agent Factory: [`standards/agent-factory.md`](standards/agent-factory.md)
- AUDREY Agent: [`standards/audrey-autonomous-agent.md`](standards/audrey-autonomous-agent.md)
