...
| Document | Relevance |
|---|---|
| `standards/security.md` | Overall security requirements; Section 8 covers dependency scanning |
...
| `standards/deployment.md` | How vetted dependency updates flow through to production |
