...
## Integration with Other Standards
   ...
   - **standards/code-review.md** — All PRs must pass CodeRabbit review before merge
   - **standards/concurrent-development.md** — Teams work on feature branches and merge to main via PR
   - **standards/auto-documentation.md** — Deploy reports and changelogs are generated for every deployment
