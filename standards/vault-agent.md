...
#         (varies per server — see standards/mcp.md Section 5)
...
- `standards/security.md` — broader secret management policy
- `standards/mcp.md` — MCP credential requirements
- `standards/agent-factory.md` — agent factory and self-healing loop
