...
| Blue Team Audit Console | `products/blue-team-audit-console` | 3012 | Next.js. Greenfield-compatible blue-team agent trace auditor with flags, notes, groups, and AI_AUDIT.md export. |
...
cd products/blue-team-audit-console && npm run dev -- -p 3012
```
