...
| Orchestration Console | `products/orchestration-console` | 3012 | Next.js. Structural heal, file registry validation, n8n OAuth reference. |
...
cd products/orchestration-console && npm run dev -- -p 3012
```
