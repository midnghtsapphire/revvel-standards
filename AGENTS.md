...
| Chat Deployment Organizer | `products/chat-deployment-organizer` | 3012 | Next.js. Filter research chats into ordered Finisher deployment WRs (commerce last-mile). |
...
cd products/chat-deployment-organizer && npm run dev -- -p 3012
```
