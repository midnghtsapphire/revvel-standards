...
**Date:** April 2026  
**Status:** Active  
**Standards Reference:** [`standards/seo-metadata.md`](standards/seo-metadata.md)
...
SEO-targeted blog posts to publish at launch per [Content Standard](standards/content.md):
