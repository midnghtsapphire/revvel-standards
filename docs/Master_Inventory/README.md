# Master Inventory — Revvel Standards

> **This is the canonical location for all Revvel / MIDNGHTSAPPHIRE standards documents.**
>
> All standards, checklists, templates, and operational guides live here.
...
## Checklists & Operational Documents

| File                                                                                   | Description                                                                                           |
| -------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| [`AUTOMATION_CHECKLIST.md`](AUTOMATION_CHECKLIST.md)                                   | Automation implementation checklist for all Revvel projects                                           |
| [`COMPLIANCE_RUBRIC.md`](COMPLIANCE_RUBRIC.md)                                         | Compliance scoring rubric (see also Standards above)                                                  |
...
| Document                   | Location                                                           |
| -------------------------- | ------------------------------------------------------------------ |
| Master BOM (purchases)     | [`docs/_MASTER_BOM.md`](../_MASTER_BOM.md)                         |
| Master Standards Reference | [`docs/REVVEL_MASTER_STANDARDS.md`](../REVVEL_MASTER_STANDARDS.md) |
| Universal BOM List         | [`docs/Universal-BOM_List/`](../Universal-BOM_List/)               |
| Project Catalog            | [`docs/PROJECT_CATALOG.md`](../PROJECT_CATALOG.md)                 |
| Root README                | [`README.md`](../../README.md)                                     |

---

_Maintained by the Revvel coding agent. All standards documents belong here — not scattered in other project repositories._
