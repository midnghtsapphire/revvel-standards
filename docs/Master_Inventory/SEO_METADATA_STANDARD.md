...
export const metadata: Metadata = {
  ...
  description:
    "[What the app does in one sentence. Include primary keyword. 150-160 chars.]",
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical:
        post.canonical_url ||
        `https://[appurl].com/blog/${post.category}/${post.slug}`,
    },
    openGraph: {
...
<script
  ...
  dangerouslySetInnerHTML={{
    __html: JSON.stringify({
      ...
      applicationCategory:
        "[Category e.g., FinanceApplication, HealthApplication]",
      ...
      itemListElement: [
        {
          ...
          position: 1,
          name: "Home",
          item: "https://[appurl].com",
        },
        {
          "@type": "ListItem",
          position: 2,
          name: "Blog",
          item: "https://[appurl].com/blog",
        },
