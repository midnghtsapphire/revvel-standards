...
> `docs/API_LIMIT_AUTO_UPGRADE.md` decision standard governs _when_ an upgrade
...
- AI-generated tests still need a human/agent skim — bad input → bad tests. Treat them as a _floor_, not a ceiling.
- Free-tier rate limits are real — see auto-upgrade decision standard.

**How to use the Chrome extension**

1. Install from the Chrome Web Store: _Keploy API Test Recorder_.
