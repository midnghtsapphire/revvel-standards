...
| **[nested: …]**           | Anything _inside_ the tool that matters (downstream deps, sub-services, models) | [nested: Render for previews]       |
...
A buyer asks: _"What's actually under the hood?"_ Today the honest answer for
...
`docs/TESTING_STACK.md`; this file is just the _naming standard_.
