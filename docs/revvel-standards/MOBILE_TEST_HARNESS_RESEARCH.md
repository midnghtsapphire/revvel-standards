...
| ID             | Requirement                                                                                                                                                                                      |
| -------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **R-MTH-N-01** | Full unit + component run MUST complete in ≤ 60 s on a standard GH-hosted runner. Full E2E (Maestro on iOS _or_ Android) SHOULD complete in ≤ 12 minutes including build.                        |
...
- [`docs/revvel-standards/TEST_HARNESS_RESEARCH.md`](./TEST_HARNESS_RESEARCH.md) — parallel research for _this_ repo's documentation harness (terminology shared from §2).
