...
<https://midnghtsapphire.github.io/revvel-standards/docs/screen-recorder-finder/>
...
Source scaffold lives in `products/screen-recorder-finder/` and still needs to be
