# screen-recorder-finder — Delivery Artifacts

> Auto-generated by `scripts/app_artifact_auditor.py`. **4/7 requirements met.**
> Code path: `products/screen-recorder-finder`
> Live: [https://midnghtsapphire.github.io/revvel-standards/docs/screen-recorder-finder/](https://midnghtsapphire.github.io/revvel-standards/docs/screen-recorder-finder/)

## Definition-of-Done requirements

| Requirement | Status | Notes |
| --- | :---: | --- |
| Live deployment URL | ✅ | <https://midnghtsapphire.github.io/revvel-standards/docs/screen-recorder-finder/> |
