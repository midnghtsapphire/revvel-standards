...
- The agent PR body: `Generated by OpenRouter coder (us) via .github/workflows/openrouter-coder.yml -> scripts/openrouter_coder.py [model: claude-3.7-sonnet]`. (See `standards/AGENT_STACK_SETUP.md` for the authoritative active model configuration).
