...
<https://midnghtsapphire.github.io/revvel-standards/docs/creator-payout-tracker/>
...
Source scaffold lives in `products/creator-payout-tracker/` and still needs to be
