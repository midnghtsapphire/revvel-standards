# cli-engine — Delivery Artifacts

> Auto-generated by `scripts/app_artifact_auditor.py`. **5/7 requirements met.**
> Code path: `products/cli-engine`
> Live: [https://midnghtsapphire.github.io/revvel-standards/docs/cli-engine/](https://midnghtsapphire.github.io/revvel-standards/docs/cli-engine/)

## Definition-of-Done requirements

| Requirement | Status | Notes |
| --- | :---: | --- |
| Live deployment URL | ✅ | <https://midnghtsapphire.github.io/revvel-standards/docs/cli-engine/> |
