...
Anything produced by an LLM session (Grok, Claude, etc.) is **unverified** until
checked against a primary source. Record the session and what it claimed, then
verify before promoting the finding out of drafts.
