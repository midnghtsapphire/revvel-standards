# coldtrace — Delivery Artifacts

> Auto-generated by `scripts/app_artifact_auditor.py`. **5/7 requirements met.**
> Code path: `coldtrace`
> Live: [https://midnghtsapphire.github.io/revvel-standards/docs/coldtrace/](https://midnghtsapphire.github.io/revvel-standards/docs/coldtrace/)

## Definition-of-Done requirements

| Requirement | Status | Notes |
| --- | :---: | --- |
| Live deployment URL | ✅ | <https://midnghtsapphire.github.io/revvel-standards/docs/coldtrace/> |
