...
> Code path: `coldtrace`
> Live: [https://revvel-standards.vercel.app/docs/coldtrace/](https://revvel-standards.vercel.app/docs/coldtrace/)

## Definition-of-Done requirements

| Requirement | Status | Notes |
| --- | :---: | --- |
| Live deployment URL | ✅ | <https://revvel-standards.vercel.app/docs/coldtrace/> |
