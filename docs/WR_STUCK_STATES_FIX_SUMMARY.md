...
**Follow-up issue:** Items were still getting stuck _permanently_ — not because of
...
`issue-lifecycle.yml` clearing it from a _linked issue_ when its PR merged — PRs
