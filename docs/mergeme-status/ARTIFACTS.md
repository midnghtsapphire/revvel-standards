# mergeme-status — delivery artifacts

| Artifact | Path |
| --- | --- |
| Product app | `products/mergeme-status/` |
| Auditor | `scripts/mergeme-wiring.js` |
| Root tests | `tests/mergeme-wiring.test.js` |
