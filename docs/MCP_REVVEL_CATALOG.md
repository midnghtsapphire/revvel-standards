...
| **Note**           | Separate from `rvvel-affiliate-links-mcp`. This manages affiliate _partners_; that manages affiliate _links_. |
...
| **Note**           | This is a _data store_ for review records. `code-review-mcp-server` is the _automated scanner_. |
