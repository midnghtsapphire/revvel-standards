# Adversarial Compliance Playbook Prompt

Generate the playbook for an expert compliance fleet for research, analyze, synthesize, prosecute, deconstruct, diverticulate and conclude.

Orchestrator knowledge: different team members have fine-grained skills. We need an attorney that takes the compliance adversarial position and one that takes the corporation's side. They debate each request. They deconstruct, diverticulate, and prosecute their results. Be very specific and create the best not-yet-available solution.
