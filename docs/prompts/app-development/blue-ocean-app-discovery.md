...
- Exist in daily life, caregiving, health, home, pets, money, legal, accessibility, aging, parenting, recovery, or organization
...
- Emotional trigger this app solves
- Daily use case
- Screens/pages of the app
- Key features (MVP only)
- Data the app stores
- How AI is used inside the app
