...
| `octopus` (Octopus Review) | ✅ verified | paid | pr-review | github | octopus-route.yml, octopus-cli.yml | D023 (#17738): KEEP installed (free tier ~20 reviews/month is wanted). When out of credits, owner mutes repo access until monthly reset (docs/PR_SIGNAL_HYGIENE.md §2, REMINDERS.md). Fallback: octopus-review-fallback.yml. Not a required merge check (D024). |
