...
| ----------------------------- | ----------------------------- | --------- | ------------- | -------- | ---------------- |
| Domain registration           | `premolt.com` or similar      | Namecheap | ~$15/yr       | P1       | ❌ Not purchased |
...
| Stripe payments               | Subscription billing          | Stripe    | Transaction % | P0       | ❌ Not set up    |
...
| **Total estimated monthly**       | **~$5/mo + transaction %** |
