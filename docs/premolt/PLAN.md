...
Out of scope in _this_ PR: `BRAND.md` and `SPRINT_LOG.md` — both require Audrey's input before they are useful. They are listed here so the next agent picks them up correctly.
