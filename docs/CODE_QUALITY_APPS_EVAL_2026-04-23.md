...
- **Coveralls:** pick **Codecov _or_ Coveralls**, not both. Codecov wins for our stack (GitHub Actions can emit `lcov.info` with a one-line step; Codecov's Action is the path of least resistance after the April 2026 CircleCI removal in [#285](https://github.com/midnghtsapphire/revvel-standards/pull/285)).
...
| 2   | [Codecov](https://github.com/marketplace/codecov)                           | Coverage                        | Free (public repos)                  | None — we have _no_ coverage reporting yet                         | ⭐⭐⭐⭐ | **Adopt** (one repo first, then roll out)                                                                                |
...
and _auto-pushes fix commits_. Free for public repos, $5/mo for
...
3. **April 28, 2026** — RecurseML trial decision point. Re-evaluate
   §5.1 _only if_ the trial does not convert.
...
_Authored: April 23, 2026. Next review: April 28, 2026 (RecurseML decision date)._
