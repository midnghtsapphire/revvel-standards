        ...
        <div className="p-6 border-b border-white/10 bg-black/20">
          <SheetHeader>
            <div className="flex items-center gap-2 mb-2">
              ...
              <span
                className={`text-xs uppercase font-mono tracking-widest ${glowClass}`}
              >
                {node.type} Node
              </span>
            </div>
            <SheetTitle className="text-2xl font-sans text-white">
              {node.title}
            </SheetTitle>
        ...
        <ScrollArea className="flex-1 p-6">
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <h4 className="text-xs uppercase font-mono text-white/50 tracking-wider mb-1">
                  Branch Label
                </h4>
            ...
            <div className="pt-4 border-t border-white/10">
              <h4 className="text-xs uppercase font-mono text-white/50 tracking-wider mb-2">
                System Metadata
              </h4>
