    ...
    <div className="w-72 border-r border-white/10 glass-panel h-screen flex flex-col fixed left-0 top-0 overflow-hidden z-20">
      <div className="p-4 border-b border-white/10 flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <h2 className="font-bold text-lg font-mono tracking-tight text-white">
            GOVERNANCE
          </h2>
        </div>
        <Button
      ...
      <div className="flex-1 overflow-y-auto p-3 space-y-2">
        <div className="text-xs font-mono text-muted-foreground uppercase tracking-wider mb-3 px-2">
          Decision Flows
        </div>
