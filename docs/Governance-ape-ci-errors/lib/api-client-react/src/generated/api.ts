...
export const getGetFlowSummaryQueryKey = (id: number) => {
  return [`/api/flows/${id}/summary`] as const;
};

export const getGetFlowSummaryQueryOptions = <
  TData = Awaited<ReturnType<typeof getFlowSummary>>,
  TError = ErrorType<void>,
>(
  id: number,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getFlowSummary>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getFlowSummary>>> = ({
    signal,
  }) => getFlowSummary(id, { signal, ...requestOptions });
...
export type GetFlowSummaryQueryResult = NonNullable<
  Awaited<ReturnType<typeof getFlowSummary>>
>;
...
export function useGetFlowSummary<
  TData = Awaited<ReturnType<typeof getFlowSummary>>,
  TError = ErrorType<void>,
>(
  id: number,
