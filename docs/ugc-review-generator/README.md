...
<https://midnghtsapphire.github.io/revvel-standards/docs/ugc-review-generator/>
...
Source scaffold lives in `products/ugc-review-generator/` and still needs to be
