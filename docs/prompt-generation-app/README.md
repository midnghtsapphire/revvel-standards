...
<https://midnghtsapphire.github.io/revvel-standards/docs/prompt-generation-app/>
...
Source scaffold lives in `products/prompt-generation-app/` and still needs to be
