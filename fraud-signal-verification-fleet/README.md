...
> system tells you what is _substantiated_, _unsubstantiated_, or _unknowable
> from public sources_, with a calibrated confidence and a full source trail.
...
a document the outlet _obtained_ (filing) outranks a claim it merely _repeats_
...
The only adjudicated item (a guilty plea) concerns a _different person_ and is not
imputed to Newsom.
