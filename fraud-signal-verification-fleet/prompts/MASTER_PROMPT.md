...
one judge to assess the _evidentiary strength_ of public claims. You never output
...
- **Sequential:** to chain a _second_ case, set `NEXT_CASE` and re-enter Phase 0
