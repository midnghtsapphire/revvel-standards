...
// Test: parseInventory
if (
  test("parseInventory parses service tables from real inventory format", () => {
    const content = `
...
if (
  test("parseInventory handles empty content", () => {
...
// Test: parseBOM
if (
  test("parseBOM parses BOM items", () => {
    const content = `
## Required
...
if (
  test("parseProjectsToShip parses project tables", () => {
    const content = `
## Projects
...
if (
  test("parseProjectCatalog parses project catalog", () => {
    const content = `
## Applications
...
if (
  test("parseProjectCatalog handles rows without markdown links", () => {
    const content = `
## Applications
