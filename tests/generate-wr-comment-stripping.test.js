#!/usr/bin/env node
// RECONSTRUCTED 2026-07-08 (see standards/GREEN_MAIN_STANDARD.md): four
// parallel fixes for the same regression were merged on top of each other,
// splicing one script's header into another's final assert and leaving the
// file unparseable. The self-contained suite below is the superset survivor;
// it covers single-line stripping, multi-line stripping, and the real
// WR_TEMPLATE_FULL.md integration case the fragments each tested.
"use strict";
