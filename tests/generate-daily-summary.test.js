...
// NOTE:
// Query construction for fetchPRsSince/fetchIssuesSince is intentionally not
// tested here. Reconstructing the expected template literal in this file does
// not exercise the production implementation and can produce false confidence.
// Add behavioral coverage once the query-building logic is exported or the
// script is refactored to be importable in tests.
