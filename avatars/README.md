# Avatar Repository - Master Index

This repository stores all work avatars for video production across all platforms.
...
│   ├── casual/              # Social media, TikTok, Facebook
│   ├── formal/              # Events, movies, legal
│   ├── athletic/            # Fitness, wellness content
│   └── creative/            # Artistic, music videos
├── personal/                # Personal use avatars
├── personas/                # AI personas for different contexts
└── uploads/                 # Source files for avatar generation
```
...
- **Youthful vitality** - Energetic, fresh, vibrant look
...
- Clean background (solid or gradient)
...
├── outfit-casual/           # Casual wear
├── outfit-formal/           # Formal events
├── outfit-athletic/         # Active/lifestyle
├── outfit-creative/         # Artistic/expressive
...
1. Select avatar from `avatars/work/`
2. Choose appropriate outfit folder
3. Generate with HeyGen/D-ID/Synthesia
4. Save output to project folder
5. Document in SHIP_STATUS.md

## Maintenance

- Update avatar library quarterly
- Add new outfits as wardrobe changes
