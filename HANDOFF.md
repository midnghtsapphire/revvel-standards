...
| 4 | **Docs: CUDA_AGENT_MODEL + AGENT_APP_LINEUP** — the diagram + naming reference for coders; the plain-English lineup guide for the owner. Seeded from 90-day WR scan. Log D013–D015 | ⏳ blocked on Block 3 | — | docs/CUDA_AGENT_MODEL.md, docs/AGENT_APP_LINEUP.md, DECISIONS.md |
