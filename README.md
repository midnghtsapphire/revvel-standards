...
43 wired integrations (40 verified). Full table: [docs/CONNECTIONS_REGISTRY.md](docs/CONNECTIONS_REGISTRY.md) · on-demand dashboard: [connections-dashboard.html](connections-dashboard.html). SSOT: `config/connections.yml`.

| Category | Count | Examples |
| --- | ---: | --- |
| Agents & orchestration | 9 | `claude`, `openrouter`, `openhands`, `jules`, … |
| MCP servers | 14 | `mcp-github`, `mcp-linear`, `mcp-notion`, `mcp-slack`, … |
| APIs | 15 | `perplexity`, `crewai`, `xai`, `tavily`, … |
| Libraries | 1 | `vader` |
