...
40 wired integrations (37 verified). Full table: [docs/CONNECTIONS_REGISTRY.md](docs/CONNECTIONS_REGISTRY.md) · on-demand dashboard: [connections-dashboard.html](connections-dashboard.html). SSOT: `config/connections.yml`.
...
| GitHub apps / bots | 3 | `octopus`, `bito`, `augment` |
