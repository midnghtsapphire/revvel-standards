...
45 wired integrations (42 verified). Full table: [docs/CONNECTIONS_REGISTRY.md](docs/CONNECTIONS_REGISTRY.md) · on-demand dashboard: [connections-dashboard.html](connections-dashboard.html). SSOT: `config/connections.yml`.
...
| Libraries | 1 | `vader` |
| GitHub apps / bots | 5 | `octopus`, `bito`, `augment`, `vercel`, … |
...
- **flake8** (`py-actions/flake8@v2.3.0`) - Python style/error lint in CI — see [docs/PYTHON_FLAKE8_LINT.md](docs/PYTHON_FLAKE8_LINT.md)
