...
🧩 **[Live HTML Dashboard Process](docs/process/LIVE_HTML_DASHBOARD_PROCESS.md)** — 5-step standard for MCP-connected, reusable, live HTML dashboards and where each project type must use it  
...
| Building a live HTML dashboard (MCP + runtime scripts + Vercel URL) | [`docs/process/LIVE_HTML_DASHBOARD_PROCESS.md`](docs/process/LIVE_HTML_DASHBOARD_PROCESS.md) | Process standard |
