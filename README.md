...
46 wired integrations (42 verified). Full table: [docs/CONNECTIONS_REGISTRY.md](docs/CONNECTIONS_REGISTRY.md) · on-demand dashboard: [connections-dashboard.html](connections-dashboard.html). SSOT: `config/connections.yml`.
...
| Libraries | 1 | `vader` |
| GitHub apps / bots | 6 | `octopus`, `bito`, `augment`, `vercel`, … |
