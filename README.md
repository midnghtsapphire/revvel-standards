...
Organization README badges are generated by
[`.github/workflows/organization-readme-badges.yml`](.github/workflows/organization-readme-badges.yml)
using [`joshjohanning/organization-readme-badge-generator@v2.0.3`](https://github.com/joshjohanning/organization-readme-badge-generator).
Set repository variable `ORG_README_BADGES_ORG` (or pass `organization` on
`workflow_dispatch`) to an organization login before the scheduled job fills
the markers above.
