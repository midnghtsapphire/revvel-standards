# Website + Mobile UI System Template (Glassmorphic S2M)

Use this template when a WR requires a full front-to-back website and mobile experience artifact.

## 1) Master visual prompts (glassmorphic, premium realism)

### Prompt 1 — Dark Mode Analytics Dashboard
...
### Prompt 3 — Interactive Agent Canvas
...
- [ ] Product/app explainer video artifact generated and linked in project docs

## 4) Research and trend engine outputs (required)
...
- [ ] Text legibility check (font collisions/overlap prevented at all breakpoints)
- [ ] Image quality check (no dead/blurred/lifeless hero assets)
- [ ] Checkout/cart functional test pass
- [ ] Mobile parity test pass (web ↔ iOS ↔ Android flows)
- [ ] Artifact links added to project README `## Test` table
