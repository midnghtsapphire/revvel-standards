...
test.describe("S.H.I.F.T. Monitor: Core Workflows", () => {
  ...
  test("Bad Day Simulation: External API Failure (Self-Healing Check)", async ({
    page,
  }) => {
    ...
    const errorMessage = page
      .locator("text=We couldn't load the latest updates right now")
      .or(page.locator("text=Please try again later"));
