...
class Config:
    ...
    def _load_config(self) -> dict:
        ...
        return {
            "doppler": {
                "token": os.getenv("DOPPLER_TOKEN") or os.getenv("DOPPLER_LOCAL_TOKEN") or os.getenv("DOPPLER_API_KEY") or os.getenv("DOPPLER_AGENT_ODIC") or os.getenv("DOPPLER_CIRCLECI_OIDC") or os.getenv("DOPPLER_AGENT_TOKEN") or doppler_config.get("token"),
